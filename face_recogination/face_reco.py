...
#%%
face_1 = np.load(r'M:\face_recogination\face_recogination\faces/user_1.npy').reshape(51, 50*50)
face_2 = np.load(r'M:\face_recogination\face_recogination\faces/user_2.npy').reshape(23, 50*50)
#%%
